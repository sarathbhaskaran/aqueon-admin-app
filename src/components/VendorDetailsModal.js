...
const VendorDetailsModal = ({vendorId}) => {
    ...
    const fetchSummary = async () => {
        ...
        await axios.get(`/vendor-services?vendorId=${vendorId}`).then(res => {
            unstable_batchedUpdates(() => {
                console.log("res.data.vendorServices", res.data.vendorServices)
        ...
        await axios.get(`/fetch-vendor-certificates?vendorId=${vendorId}`)
            .then(res => {
        ...
        await axios.get(`/vendors/billing-addres?vendorId=${vendorId}`, vendorId)
            .then(res => {
        ...
        await axios.get(`/vendors/profile/info?vendorId=${vendorId}`, vendorId
        )
            .then(res => {
